...
安心企業研修アンゼット（Anzet）のクローズドβ（自社/知人企業 3〜5社・50〜100アカウント規模）
実施前後で確認する項目。批判的レビュー（⭐2.5/5、project_anzet.md参照）を踏まえ、
特にチャネル・スコープの検証を重視する。
...
- [ ] `anzet/firestore.rules` をFirebase Consoleへデプロイ
...
- [ ] J-PlatPat商標検索でタイトル「Anzet」の国内商標リスクを確認（設計書1-C参照、未実施）
...
## C. 批判的レビュー（project_anzet.md参照）への対応状況
